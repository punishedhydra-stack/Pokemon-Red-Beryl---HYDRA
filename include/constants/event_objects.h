...
enum
{
    ...
    OBJ_EVENT_GFX_INCUBATOR, //HYDRA egg incubator secret base decoration (4 state frames)
    OBJ_EVENT_GFX_RADIO, //HYDRA radio secret base decoration (static 16x16, plays a chosen track)
    OBJ_EVENT_GFX_HYDRA_BED_RED, //HYDRA healing bed
    OBJ_EVENT_GFX_HYDRA_BED_BLUE, //HYDRA healing bed
    OBJ_EVENT_GFX_HYDRA_BED_YELLOW, //HYDRA healing bed
    OBJ_EVENT_GFX_HYDRA_BED_GREEN, //HYDRA healing bed
    OBJ_EVENT_GFX_HYDRA_BED_ORANGE, //HYDRA healing bed
    OBJ_EVENT_GFX_HYDRA_BED_PURPLE, //HYDRA healing bed
    OBJ_EVENT_GFX_HYDRA_BED_WHITE, //HYDRA healing bed
    OBJ_EVENT_GFX_HYDRA_BED_BLACK, //HYDRA healing bed
    OBJ_EVENT_GFX_HYDRA_BED_PINK, //HYDRA healing bed
    NUM_OBJ_EVENT_GFX,
};
...
#define OBJ_EVENT_ID_FOLLOWER_2                 248
...
#define OBJ_EVENT_PAL_TAG_BERRY_DIRT_PILE_WATERED 0x116C //HYDRA
#define OBJ_EVENT_PAL_TAG_INCUBATOR               0x116E //HYDRA egg incubator decoration palette (was 0x116D; collided with BALL_POKE)
#define OBJ_EVENT_PAL_TAG_RADIO                   0x116F //HYDRA radio decoration palette
#define OBJ_EVENT_PAL_TAG_HYDRA_BED_RED     0x1170 //HYDRA
#define OBJ_EVENT_PAL_TAG_HYDRA_BED_BLUE    0x1171 //HYDRA
#define OBJ_EVENT_PAL_TAG_HYDRA_BED_YELLOW  0x1172 //HYDRA
#define OBJ_EVENT_PAL_TAG_HYDRA_BED_GREEN   0x1173 //HYDRA
#define OBJ_EVENT_PAL_TAG_HYDRA_BED_ORANGE  0x1174 //HYDRA
#define OBJ_EVENT_PAL_TAG_HYDRA_BED_PURPLE  0x1175 //HYDRA
#define OBJ_EVENT_PAL_TAG_HYDRA_BED_WHITE   0x1176 //HYDRA
#define OBJ_EVENT_PAL_TAG_HYDRA_BED_BLACK   0x1177 //HYDRA
#define OBJ_EVENT_PAL_TAG_HYDRA_BED_PINK    0x1178 //HYDRA
...
#define OBJ_EVENT_PAL_TAG_BALL_POKE				  0x116D
// Gen IV/Sinnoh
...
#define OBJ_EVENT_PAL_TAG_POKEBOX                 0x116B
