...
#define OBJECT_EVENTS_COUNT 24 //HYDRA was 16; raised for more simultaneous overworld objects (followers + NPCs + OW encounters). Grows SaveBlock1.
//HYDRA quick hotbar (Select button)
#define HOTBAR_SLOTS          8
#define HOTBAR_SLOT_EMPTY     0
#define HOTBAR_FIELDMOVE_FLAG 0x8000 // set in a slot value => low bits are a FIELD_MOVE_ id, not an ITEM_ id (phase 2)
