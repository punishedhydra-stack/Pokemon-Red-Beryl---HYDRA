...
//HYDRA HYPER PC decoration metatiles (floor furniture, 1x2)
#define METATILE_SecretBase_HyperTrainingPC_Top         0x344
#define METATILE_SecretBase_HyperTrainingPC_TopWall     0x345
#define METATILE_SecretBase_HyperTrainingPC_Base        0x346
#define METATILE_SecretBase_HyperTrainingPC_BaseWall    0x347
//HYDRA "screen on" frame, shown while the boot message is up
#define METATILE_SecretBase_HyperTrainingPC_TopOn       0x348
#define METATILE_SecretBase_HyperTrainingPC_TopWallOn   0x349
#define METATILE_SecretBase_HyperTrainingPC_BaseOn      0x34A
#define METATILE_SecretBase_HyperTrainingPC_BaseWallOn  0x34B
