...
#define DECOR_HYPER_TRAINING_PC 121 //HYDRA
#define DECOR_EGG_INCUBATOR     122 //HYDRA egg incubator (sprite decoration, up to 6 per base)
#define DECOR_RADIO             123 //HYDRA radio (sprite decoration, limit 1, plays a chosen track in your base)
#define DECOR_RED_BED    124 //HYDRA healing bed
#define DECOR_BLUE_BED   125 //HYDRA healing bed
#define DECOR_YELLOW_BED 126 //HYDRA healing bed
#define DECOR_GREEN_BED  127 //HYDRA healing bed
#define DECOR_ORANGE_BED 128 //HYDRA healing bed
#define DECOR_PURPLE_BED 129 //HYDRA healing bed
#define DECOR_WHITE_BED  130 //HYDRA healing bed
#define DECOR_BLACK_BED  131 //HYDRA healing bed
#define DECOR_PINK_BED   132 //HYDRA healing bed
#define NUM_DECORATIONS DECOR_PINK_BED
