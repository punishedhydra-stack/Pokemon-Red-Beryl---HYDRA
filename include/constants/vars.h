...
#define VAR_UNUSED_0x404E                                0x404E // Unused Var (taken by DexNav DN_VAR_SPECIES in config/dexnav.h)
...
#define VAR_HYDRA_RADIO_TRACK                            0x408B // HYDRA radio decoration: chosen MUS_ id (0 = off). Was 0x404E, which collided with DexNav DN_VAR_SPECIES and corrupted the radio track.
...
//HYDRA Secret-base Fly/Teleport destination (reuses unused vars; aliases keep the originals intact)
#define VAR_SECRET_BASE_DOOR_MAPSEC                      VAR_UNUSED_0x40F7 //HYDRA region-map section the base is on
#define VAR_SECRET_BASE_DOOR_LOCATION                    VAR_UNUSED_0x40F8 //HYDRA (mapGroup << 8) | mapNum of that route
#define VAR_SECRET_BASE_DOOR_X                           VAR_UNUSED_0x40F9 //HYDRA x tile in front of the entrance
#define VAR_SECRET_BASE_DOOR_Y                           VAR_UNUSED_0x40FA //HYDRA y tile in front of the entrance
#define VAR_SECRET_BASE_DOOR_SET                         VAR_UNUSED_0x40FB //HYDRA 1 once a door has actually been recorded
