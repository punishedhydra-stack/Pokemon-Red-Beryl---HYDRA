...
enum {
    ...
    GFXTAG_BUBBLE,
    GFXTAG_RAIN,
    GFXTAG_HAIL_TINY,  // Just one hail tag
};
enum {
...
//HYDRA overworld hail weather (falling hail graphic + ice-crystal impact pop)
...
void TryUpdateZoneWeatherHourly(void); //HYDRA live hourly zone weather (defined in field_weather_effect.c)
void SetWeather(u32 weather);
//HYDRA in-battle sun (drought) terrain tint helpers (defined in field_weather.c)
