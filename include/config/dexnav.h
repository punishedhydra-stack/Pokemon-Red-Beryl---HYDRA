...
// Flag/var defines
#define DN_FLAG_SEARCHING             FLAG_UNUSED_0x020 //HYDRA Searching for mon
#define DN_FLAG_DEXNAV_GET            FLAG_UNUSED_0x021 //HYDRA DexNav shows in start menu
#define DN_FLAG_DETECTOR_MODE         FLAG_UNUSED_0x022 //HYDRA Allow player to find hidden mons
#define DN_VAR_SPECIES                VAR_UNUSED_0x404E //HYDRA Registered DexNav species
#define DN_VAR_STEP_COUNTER           VAR_UNUSED_0x4083 //HYDRA Steps for finding hidden Pokémon
