...
// Configuration
#define OW_AMBIENT_CRIES                OW_AMBIENT_CRIES_OWE_PRIORITY //HYDRA // Selects how ambient cries are played, if at all. As in vanilla, no matter what is chosen, cries will not play if the player is not on a map with Land or Water encounter tables.
