...
extern const u8 SecretBase_EventScript_HyperTrainingPC[]; //HYDRA
extern const u8 SecretBase_EventScript_DollInteract[];
extern const u8 SecretBase_EventScript_IncubatorInteract[]; //HYDRA egg incubator interaction
extern const u8 SecretBase_EventScript_RadioInteract[]; //HYDRA radio interaction
extern const u8 SecretBase_EventScript_BedInteract[]; //HYDRA healing bed interaction
