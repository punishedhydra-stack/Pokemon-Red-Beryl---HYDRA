...
bool32 IsBattleActionSelectionActive(void); //HYDRA true while the Fight/Bag/Pokemon/Run selection menu is up
bool32 IsBattleBeforeFirstTurn(void); //HYDRA true during the pre-first-turn intro (so rain shows from the start)
