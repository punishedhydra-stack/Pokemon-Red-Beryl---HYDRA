...
#define B_ANIM_SPEED_PERCENT 150       //HYDRA - animation speed: 100 = 1.0x, 120 = 1.2x, 150 = 1.5x
#define B_ANIM_SPEED_PITCH_PERCENT 100 //HYDRA - audio pitch: 100 = no shift; set = B_ANIM_SPEED_PERCENT for full compression
...
void BattleAnim_UnloadSpriteGfxAndPalByTag(u16 gfxTag, u16 palTag); //HYDRA full unload incl. load-tracking
...
#define STAT_ANIM_MULTIPLE_BATTLERS (1 << 7) // OR'd into the anim arg to draw the effect on a battler and its partner in one launch
