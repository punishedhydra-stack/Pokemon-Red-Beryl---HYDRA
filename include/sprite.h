...
#define MAX_SPRITES 96 //HYDRA was 64; raised so busy maps (24 object events + 2 followers + OW encounters + per-object shadows/grass) don't exhaust the sprite pool and crash ("Out of sprite slots"). gSprites is EWRAM so this is cheap; OAM hardware is 128.
