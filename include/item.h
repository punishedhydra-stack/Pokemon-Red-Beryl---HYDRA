...
void ItemUseOutOfBattle_RefillablePotion(u8 taskId); //HYDRA
bool32 IsVialItem(u32 item); //HYDRA
u32 GetVialMaxCharges(void); //HYDRA
u32 GetOwnedVialTier(void); //HYDRA
void OnVialAcquired(u32 newVial); //HYDRA
void FillVialChargesToMax(void); //HYDRA
