...
extern const u8 gText_Furniture[]; //HYDRA
extern const u8 gText_Misc[]; //HYDRA
...
extern const u8 gText_Reorganize[]; //HYDRA
extern const u8 gText_MoveDecorationsAround[]; //HYDRA
extern const u8 gText_MoveThisDecoration[]; //HYDRA
...
extern const u8 gText_SavingLevelCap[]; //HYDRA
