...
struct BattleStruct
{
    ...
    u8 spreadStatAnimPos:1; //HYDRA - a both-foes spread stat-raise anim already covered this move
    u8 spreadStatAnimNeg:1; //HYDRA - a both-foes spread stat-drop anim already covered this move
    u8 ignoreDefiant:1;
