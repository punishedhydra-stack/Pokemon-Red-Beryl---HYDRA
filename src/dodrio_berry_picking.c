...
#if !FREE_LINK //HYDRA Dodrio Berry Picking gutted (link minigame)
...
void StartDodrioBerryPicking(u16 partyId, MainCallback exitCallback) { SetMainCallback2(exitCallback); }
void IsDodrioInParty(void) { gSpecialVar_Result = FALSE; }
void ShowDodrioBerryPickingRecords(void) {}
