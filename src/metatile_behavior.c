...
//HYDRA HYPER PC decoration interaction behavior
bool8 MetatileBehavior_IsSecretBaseHyperTrainingPC(u8 metatileBehavior)
{
    if (metatileBehavior == MB_SECRET_BASE_HYPER_TRAINING_PC)
        return TRUE;
    else
        return FALSE;
}
