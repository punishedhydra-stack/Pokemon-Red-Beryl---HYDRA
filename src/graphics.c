...
// Hotbar arrow
const u32 gHotbarArrowSpriteGfx[] = INCGFX_U32("graphics/interface/hotbar_arrow.png", ".4bpp"); //HYDRA uncompressed to match LoadSpriteSheet (was .4bpp.smol -> garbled)
const u16 gHotbarArrowSpritePal[] = INCGFX_U16("graphics/interface/hotbar_arrow.png", ".gbapal");
const u32 gHotbarPlusSpriteGfx[] = INCGFX_U32("graphics/interface/hotbar_plus.png", ".4bpp"); //HYDRA uncompressed to match LoadSpriteSheet (was .4bpp.smol -> nothing/garbled)
const u16 gHotbarPlusSpritePal[] = INCGFX_U16("graphics/interface/hotbar_plus.png", ".gbapal");
