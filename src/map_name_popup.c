...
static const u8 sMapPopUp_Table[][960] =
{
	...
	[MAPPOPUP_THEME_ITEM]       = INCGFX_U8("graphics/map_popup/item.png", ".4bpp"),
};
...
static const u8 sMapPopUp_OutlineTable[][960] =
{
	...
	[MAPPOPUP_THEME_ITEM]       = INCGFX_U8("graphics/map_popup/item_outline.png", ".4bpp"),
};
...
static const u16 sMapPopUp_PaletteTable[][16] =
{
	...
	[MAPPOPUP_THEME_ITEM]       = INCGFX_U16("graphics/map_popup/item.png", ".gbapal"),
};
