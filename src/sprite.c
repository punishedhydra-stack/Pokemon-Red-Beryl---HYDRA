...
void ResetSpriteData(void)
{
    ...
    gOamLimit = 96; //HYDRA was 64; match MAX_SPRITES so the extra sprites actually render (OAM hardware supports 128)
...
__attribute__((section(".iwram"), long_call)) void BuildOamBuffer(void) //HYDRA IWRAM: per-frame OAM build/sort over all sprites (helps busy grass scenes)
{
