...
#include "battle_weather.h" //HYDRA reload the in-battle weather overlay after the screen is rebuilt
#include "data.h"
...
static void CB2_ReshowBattleScreenAfterMenu(void)
{
    ...
    default:
        ...
        BattleWeather_ForceReload(); //HYDRA VRAM was wiped rebuilding the screen -> reload the weather tiles
        break;
    }
