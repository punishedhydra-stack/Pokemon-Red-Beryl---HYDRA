...
//static void OpponentHandleChooseItem(enum BattlerId battler); //HYDRA removed: definition is commented out; CONTROLLER_OPENBAG now maps to BtlController_Empty
...
//static void OpponentHandleChooseItem(enum BattlerId battler) //HYDRA
//{
