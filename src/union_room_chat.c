...
//HYDRA: general string case-toggle table (used by string_util.c) - kept out of the link guard
...
#if !FREE_LINK //HYDRA gut: link app layer (Stage 2)
...
#endif //HYDRA !FREE_LINK (link app layer removed; stubs in link_stubs.c)