...
void BattleSetup_StartTrainerBattle(void)
{
    ...
    else
    {
        ...
        {
            gBattleTypeFlags = (BATTLE_TYPE_TRAINER | BATTLE_TYPE_DOUBLE); //HYDRA
        }
    }
...
void BattleSetup_StartRematchBattle(void)
{
    ...
    if (GetMonData2(&gParties[B_TRAINER_OPPONENT_A][0], MON_DATA_SANITY_HAS_SPECIES)
     && !GetMonData2(&gParties[B_TRAINER_OPPONENT_A][1], MON_DATA_SANITY_HAS_SPECIES))
    {
