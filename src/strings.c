...
const u8 gText_PkmnNeedsToReplaceMove[] = _("Should {STR_VAR_1} learn\n{STR_VAR_2}?");
...
const u8 gText_Reorganize[] = _("REORGANIZE");//HYDRA
const u8 gText_MoveDecorationsAround[] = _("Move decorations around.");
...
const u8 gText_MoveThisDecoration[] = _("Move this decoration?"); //HYDRA
...
const u8 gText_Furniture[] = _("FURNITURE"); //HYDRA decoration category (desks + chairs)
const u8 gText_Misc[] = _("MISC"); //HYDRA decoration category (HYPER PC + incubator)
...
const u8 gText_SavingLevelCap[] = _("LEVEL CAP"); //HYDRA
