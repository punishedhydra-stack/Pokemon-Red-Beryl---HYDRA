...
static const u8 sText_StolenItemPlacedInBag[] = _("Stolen {B_BUFF1} was placed in your bag.\p");
...
static const u8 sText_WildPkmnAppeared[] = _("");
...
const u8 *const gBattleStringsTable[STRINGID_COUNT] =
{
    ...
    [STRINGID_BATTLERFAINTED]                       = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX} fainted!"),
    ...
    [STRINGID_PKMNMADESLEEP]                        = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX}'s {B_BUFF1} made {B_EFF_NAME_WITH_PREFIX2} sleep!"),
	[STRINGID_STOLENITEMTOBAG] = COMPOUND_STRING("Stolen {B_BUFF1} was placed in your bag.\p"),
    ...
    [STRINGID_OPPOSINGMONSSTATFELL]             	= COMPOUND_STRING("The opposing Pokémon's {B_BUFF1} {B_BUFF2}fell!"),
    [STRINGID_YOURMONSSTATFELL]                 	= COMPOUND_STRING("Your Pokémon's {B_BUFF1} {B_BUFF2}fell!"),
	...
	[STRINGID_NOITEMSINTRAINERBATTLE] 				= COMPOUND_STRING("Items cannot be used in trainer battles!"), //HYDRA
};
...
const u16 gStatFellMultipleStringIds[] =
{
    [B_SIDE_PLAYER]   = STRINGID_YOURMONSSTATFELL,
    [B_SIDE_OPPONENT] = STRINGID_OPPOSINGMONSSTATFELL,
};
