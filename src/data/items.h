...
// Medicine
	...
	[ITEM_NURSES_VIAL] = //HYDRA
	{
		.name = ITEM_NAME("Nurse's Vial"),
		.price = 0,
		.description = COMPOUND_STRING(
			"Restores 20 HP\n"
			"per charge."),
		...
		.sortType = ITEM_TYPE_HEALTH_RECOVERY,
		.type = ITEM_USE_PARTY_MENU,
		.fieldUseFunc = ItemUseOutOfBattle_RefillablePotion,
		.battleUsage = EFFECT_ITEM_RESTORE_HP, //HYDRA
		.effect = gItemEffect_Potion,
		.notConsumed = TRUE,
		.importance = 1, //HYDRA
		.iconPic = gItemIcon_NursesVial,
		.iconPalette = gItemIconPalette_NursesVial,
	},

	[ITEM_SUPER_VIAL] = //HYDRA
	{
		.name = ITEM_NAME("Super Vial"),
		.price = 100000,
		.description = COMPOUND_STRING(
			"Restores 60 HP\n"
			"per charge."),
		...
		.notConsumed = TRUE,
		.importance = 1, //HYDRA
		.shopCriteriaFunc = ShopCriteria_Vial, //HYDRA
		.iconPic = gItemIcon_SuperVial, //HYDRA
		.iconPalette = gItemIconPalette_SuperVial,
	},

	[ITEM_HYPER_VIAL] = //HYDRA
	{
		.name = ITEM_NAME("Hyper Vial"),
		.price = 100000,
		.description = COMPOUND_STRING(
			"Restores 120 HP\n"
			"per charge."),
		...
		.importance = 1, //HYDRA
		.shopCriteriaFunc = ShopCriteria_Vial, //HYDRA
		.iconPic = gItemIcon_HyperVial, //HYDRA
		.iconPalette = gItemIconPalette_HyperVial,
	},

	[ITEM_MAX_VIAL] = //HYDRA
	{
		.name = ITEM_NAME("Max Vial"),
		.price = 100000,
		.description = COMPOUND_STRING(
			"Restores all HP\n"
			"per charge."),
		...
		.importance = 1, //HYDRA
		.shopCriteriaFunc = ShopCriteria_Vial, //HYDRA
		.iconPic = gItemIcon_MaxVial, //HYDRA
		.iconPalette = gItemIconPalette_MaxVial,
	},

	[ITEM_MASTER_VIAL] = //HYDRA
	{
		.name = ITEM_NAME("Master Vial"),
		.price = 100000,
		.description = COMPOUND_STRING(
			"Fully restores\n"
			"per charge."),
		...
		.type = ITEM_USE_PARTY_MENU,
		.fieldUseFunc = ItemUseOutOfBattle_RefillablePotion,
		.battleUsage = EFFECT_ITEM_HEAL_AND_CURE_STATUS, //HYDRA
		.effect = gItemEffect_FullRestore,
		.notConsumed = TRUE,
		.importance = 1, //HYDRA
		.shopCriteriaFunc = ShopCriteria_Vial, //HYDRA
		.iconPic = gItemIcon_MasterVial, //HYDRA
		.iconPalette = gItemIconPalette_MasterVial,
	},
