...
//HYDRA egg incubator state anims: 0 = empty (frame 0), 1 = incubating (frames 1<->2), 2 = ready (frame 3)
static const union AnimCmd sAnim_IncubatorEmpty[] =
{
    ANIMCMD_FRAME(0, 8),
    ANIMCMD_JUMP(0),
};
//HYDRA Pokébox animated (3 frames: 0=idle, 1=open1, 2=open2)
static const union AnimCmd sAnim_Pokebox[] =
{
    ANIMCMD_FRAME(0, 60),  // Just show frame 0 (closed), duration doesn't matter much
    ANIMCMD_JUMP(0),       // Stay on frame 0
};
static const union AnimCmd *const sAnimTable_Pokebox[] = {
    [ANIM_STAY_STILL] = sAnim_Pokebox,
};
static const union AnimCmd sAnim_IncubatorIncubating[] =
{
    ANIMCMD_FRAME(1, 30),
    ANIMCMD_FRAME(2, 30),
    ANIMCMD_JUMP(0),
};
static const union AnimCmd sAnim_IncubatorReady[] =
{
    ANIMCMD_FRAME(3, 8),
    ANIMCMD_JUMP(0),
};
static const union AnimCmd *const sAnimTable_Incubator[] =
{
    sAnim_IncubatorEmpty,
    sAnim_IncubatorIncubating,
    sAnim_IncubatorReady,
};
