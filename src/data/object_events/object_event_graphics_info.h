...
//HYDRA egg incubator secret base decoration: 16x32, 4 state frames, own palette, no shadow.
// inanimate so the movement system leaves it on anim 0 (empty) by default; state-driven
// frame control is applied at runtime in later stages.
const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_Incubator = {
    .tileTag = TAG_NONE,
    .paletteTag = OBJ_EVENT_PAL_TAG_INCUBATOR,
    ...
    .oam = &gObjectEventBaseOam_16x32,
    .subspriteTables = sOamTables_16x32,
    .anims = sAnimTable_Incubator,
    .images = sPicTable_Incubator,
};

//HYDRA radio - static 16x32 sprite decoration; the tall sprite's top half draws over the player
// when the player stands behind it (same as any 16x32 object event, e.g. the incubator).
const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_Radio = {
    .tileTag = TAG_NONE,
    .paletteTag = OBJ_EVENT_PAL_TAG_RADIO,
    .reflectionPaletteTag = OBJ_EVENT_PAL_TAG_NONE,
    .size = 256,
    .width = 16,
    .height = 32,
    ...
    .images = sPicTable_Radio,
};

//HYDRA healing bed - 9 colours share one 32x32 pic + inanimate anim, differ only by palette tag
const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_HydraBedRed = {
    .tileTag = TAG_NONE, .paletteTag = OBJ_EVENT_PAL_TAG_HYDRA_BED_RED, .reflectionPaletteTag = OBJ_EVENT_PAL_TAG_NONE,
    .size = 512, .width = 32, .height = 32, .paletteSlot = PALSLOT_NPC_1, .shadowSize = SHADOW_SIZE_NONE,
    .inanimate = TRUE, .compressed = FALSE, .tracks = TRACKS_NONE,
    .oam = &gObjectEventBaseOam_32x32, .subspriteTables = sOamTables_32x32, .anims = sAnimTable_Inanimate, .images = sPicTable_HydraBed,
};
const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_HydraBedBlue = {
    .tileTag = TAG_NONE, .paletteTag = OBJ_EVENT_PAL_TAG_HYDRA_BED_BLUE, .reflectionPaletteTag = OBJ_EVENT_PAL_TAG_NONE,
    .size = 512, .width = 32, .height = 32, .paletteSlot = PALSLOT_NPC_1, .shadowSize = SHADOW_SIZE_NONE,
    .inanimate = TRUE, .compressed = FALSE, .tracks = TRACKS_NONE,
    .oam = &gObjectEventBaseOam_32x32, .subspriteTables = sOamTables_32x32, .anims = sAnimTable_Inanimate, .images = sPicTable_HydraBed,
};
const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_HydraBedYellow = {
    .tileTag = TAG_NONE, .paletteTag = OBJ_EVENT_PAL_TAG_HYDRA_BED_YELLOW, .reflectionPaletteTag = OBJ_EVENT_PAL_TAG_NONE,
    .size = 512, .width = 32, .height = 32, .paletteSlot = PALSLOT_NPC_1, .shadowSize = SHADOW_SIZE_NONE,
    .inanimate = TRUE, .compressed = FALSE, .tracks = TRACKS_NONE,
    .oam = &gObjectEventBaseOam_32x32, .subspriteTables = sOamTables_32x32, .anims = sAnimTable_Inanimate, .images = sPicTable_HydraBed,
};
const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_HydraBedGreen = {
    .tileTag = TAG_NONE, .paletteTag = OBJ_EVENT_PAL_TAG_HYDRA_BED_GREEN, .reflectionPaletteTag = OBJ_EVENT_PAL_TAG_NONE,
    .size = 512, .width = 32, .height = 32, .paletteSlot = PALSLOT_NPC_1, .shadowSize = SHADOW_SIZE_NONE,
    .inanimate = TRUE, .compressed = FALSE, .tracks = TRACKS_NONE,
    .oam = &gObjectEventBaseOam_32x32, .subspriteTables = sOamTables_32x32, .anims = sAnimTable_Inanimate, .images = sPicTable_HydraBed,
};
const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_HydraBedOrange = {
    .tileTag = TAG_NONE, .paletteTag = OBJ_EVENT_PAL_TAG_HYDRA_BED_ORANGE, .reflectionPaletteTag = OBJ_EVENT_PAL_TAG_NONE,
    .size = 512, .width = 32, .height = 32, .paletteSlot = PALSLOT_NPC_1, .shadowSize = SHADOW_SIZE_NONE,
    .inanimate = TRUE, .compressed = FALSE, .tracks = TRACKS_NONE,
    .oam = &gObjectEventBaseOam_32x32, .subspriteTables = sOamTables_32x32, .anims = sAnimTable_Inanimate, .images = sPicTable_HydraBed,
};
const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_HydraBedPurple = {
    .tileTag = TAG_NONE, .paletteTag = OBJ_EVENT_PAL_TAG_HYDRA_BED_PURPLE, .reflectionPaletteTag = OBJ_EVENT_PAL_TAG_NONE,
    .size = 512, .width = 32, .height = 32, .paletteSlot = PALSLOT_NPC_1, .shadowSize = SHADOW_SIZE_NONE,
    .inanimate = TRUE, .compressed = FALSE, .tracks = TRACKS_NONE,
    .oam = &gObjectEventBaseOam_32x32, .subspriteTables = sOamTables_32x32, .anims = sAnimTable_Inanimate, .images = sPicTable_HydraBed,
};
const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_HydraBedWhite = {
    .tileTag = TAG_NONE, .paletteTag = OBJ_EVENT_PAL_TAG_HYDRA_BED_WHITE, .reflectionPaletteTag = OBJ_EVENT_PAL_TAG_NONE,
    .size = 512, .width = 32, .height = 32, .paletteSlot = PALSLOT_NPC_1, .shadowSize = SHADOW_SIZE_NONE,
    .inanimate = TRUE, .compressed = FALSE, .tracks = TRACKS_NONE,
    .oam = &gObjectEventBaseOam_32x32, .subspriteTables = sOamTables_32x32, .anims = sAnimTable_Inanimate, .images = sPicTable_HydraBed,
};
const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_HydraBedBlack = {
    .tileTag = TAG_NONE, .paletteTag = OBJ_EVENT_PAL_TAG_HYDRA_BED_BLACK, .reflectionPaletteTag = OBJ_EVENT_PAL_TAG_NONE,
    .size = 512, .width = 32, .height = 32, .paletteSlot = PALSLOT_NPC_1, .shadowSize = SHADOW_SIZE_NONE,
    .inanimate = TRUE, .compressed = FALSE, .tracks = TRACKS_NONE,
    .oam = &gObjectEventBaseOam_32x32, .subspriteTables = sOamTables_32x32, .anims = sAnimTable_Inanimate, .images = sPicTable_HydraBed,
};
const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_HydraBedPink = {
    .tileTag = TAG_NONE, .paletteTag = OBJ_EVENT_PAL_TAG_HYDRA_BED_PINK, .reflectionPaletteTag = OBJ_EVENT_PAL_TAG_NONE,
    .size = 512, .width = 32, .height = 32, .paletteSlot = PALSLOT_NPC_1, .shadowSize = SHADOW_SIZE_NONE,
    .inanimate = TRUE, .compressed = FALSE, .tracks = TRACKS_NONE,
    .oam = &gObjectEventBaseOam_32x32, .subspriteTables = sOamTables_32x32, .anims = sAnimTable_Inanimate, .images = sPicTable_HydraBed,
};
...
//HYDRA animated item-ball Pokébox: now 16x32, 3-frame sheet. Stays inanimate (idle = frame 0);
// the open->flash->despawn frames are driven manually by Task_PokeboxOpenAnim in item_ball.c.
const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_Pokebox = {
    .tileTag = TAG_NONE,
    .paletteTag = OBJ_EVENT_PAL_TAG_POKEBOX,
    .reflectionPaletteTag = OBJ_EVENT_PAL_TAG_NONE,
    .size = 256,
    .width = 16,
    .height = 32,
    .paletteSlot = PALSLOT_NPC_SPECIAL,
    .shadowSize = SHADOW_SIZE_S,
    .inanimate = TRUE,     // <-- CHANGE THIS TO FALSE
    .compressed = FALSE,
    .tracks = TRACKS_NONE,
    .oam = &gObjectEventBaseOam_16x32,
    .subspriteTables = sOamTables_16x32,
    .anims = sAnimTable_Pokebox,
    .images = sPicTable_Pokebox,
};
...
const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_PokeBall = {
    .tileTag = TAG_NONE,
    .paletteTag = OBJ_EVENT_PAL_TAG_BALL_POKE,
    .reflectionPaletteTag = OBJ_EVENT_PAL_TAG_NONE,
    .size = 256,
    .width = 16,
    .height = 32,
