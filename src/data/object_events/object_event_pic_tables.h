...
//HYDRA egg incubator: 4 state frames, 16x32 (2x4 tiles) each.
// frame 0 = empty, frames 1/2 = incubating cycle, frame 3 = ready to hatch
static const struct SpriteFrameImage sPicTable_Incubator[] = {
    overworld_frame(gObjectEventPic_Incubator, 2, 4, 0),
    overworld_frame(gObjectEventPic_Incubator, 2, 4, 1),
    overworld_frame(gObjectEventPic_Incubator, 2, 4, 2),
    overworld_frame(gObjectEventPic_Incubator, 2, 4, 3),
};

//HYDRA radio - single static 16x32 frame (2 tiles wide, 4 tall)
static const struct SpriteFrameImage sPicTable_Radio[] = {
    overworld_frame(gObjectEventPic_Radio, 2, 4, 0),
};

//HYDRA healing bed - single static 32x32 frame (4 tiles wide, 4 tall), shared by all 9 colors
static const struct SpriteFrameImage sPicTable_HydraBed[] = {
    overworld_frame(gObjectEventPic_HydraBed, 4, 4, 0),
};
...
//HYDRA 3 frames of 16x32 (2x4 tiles): 0 idle, 1 open1, 2 open2. Driven manually at runtime.
static const struct SpriteFrameImage sPicTable_Pokebox[] = {
    overworld_frame(gObjectEventPic_PokeboxAnimated, 2, 4, 0),
    overworld_frame(gObjectEventPic_PokeboxAnimated, 2, 4, 1),
    overworld_frame(gObjectEventPic_PokeboxAnimated, 2, 4, 2),
};
