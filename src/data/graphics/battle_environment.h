...
const u32 gBattleEnvironmentTiles_Grass[] = INCGFX_U32("graphics/battle_environment/grass/tiles.png", ".4bpp.smol");
const u16 gBattleEnvironmentPalette_Grass[] = INCGFX_U16("graphics/battle_environment/grass/palette.pal", ".gbapal");
const u32 gBattleEnvironmentTilemap_Grass[] = INCGFX_U32("graphics/battle_environment/grass/map.bin", ".smolTM");
...
const u32 gBattleEnvironmentAnimTiles_Grass[] = INCGFX_U32("graphics/battle_environment/grass/tiles.png", ".4bpp.smol");
const u32 gBattleEnvironmentAnimTilemap_Grass[] = INCGFX_U32("graphics/battle_environment/grass/map.bin", ".smolTM");

const u32 gBattleEnvironmentAnimTiles_Gym[] = INCGFX_U32("graphics/battle_environment/gym/tiles.png", ".4bpp.smol");
const u32 gBattleEnvironmentAnimTilemap_Gym[] = INCGFX_U32("graphics/battle_environment/gym/map.bin", ".smolTM");