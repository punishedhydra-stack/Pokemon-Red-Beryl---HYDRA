...
//HYDRA radio track picker. Order MUST match sRadioTracks[] in src/hydra_radio.c.
static const u8 sText_RadioOff[]        = _("Off");
static const u8 sText_RadioLittleroot[] = _("Littleroot");
static const u8 sText_RadioRoute110[]   = _("Route 110");
static const u8 sText_RadioSlateport[]  = _("Slateport");
static const u8 sText_RadioLilycove[]   = _("Lilycove");
static const u8 sText_RadioSootopolis[] = _("Sootopolis");
static const struct MenuAction sMultichoiceList_RadioTracks[] = {
    {sText_RadioOff},
    {sText_RadioLittleroot},
    {sText_RadioRoute110},
    {sText_RadioSlateport},
    {sText_RadioLilycove},
    {sText_RadioSootopolis},
};
...
static const struct MultichoiceListStruct sMultichoiceLists[] =
{
    ...
    [MULTI_RADIO_TRACKS]                               = MULTICHOICE(sMultichoiceList_RadioTracks), //HYDRA
};
