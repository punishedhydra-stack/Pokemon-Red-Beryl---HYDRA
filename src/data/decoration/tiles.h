...
//HYDRA HYPER PC decoration (1x2: top metatile then base metatile)
const u16 DecorGfx_HYPER_TRAINING_PC[] = {
    DECOR_TILE(HyperTrainingPC_Top),
    DECOR_TILE(HyperTrainingPC_Base)
};
...
//HYDRA egg incubator - sprite decoration; tiles[0] is the object event graphics id
const u16 DecorGfx_EGG_INCUBATOR[] = {
    OBJ_EVENT_GFX_INCUBATOR
};

//HYDRA radio - sprite decoration; tiles[0] is the object event graphics id
const u16 DecorGfx_RADIO[] = {
    OBJ_EVENT_GFX_RADIO
};

//HYDRA healing bed - tiles[0] is the object event graphics id (one per colour)
const u16 DecorGfx_RED_BED[] = { OBJ_EVENT_GFX_HYDRA_BED_RED }; //HYDRA
const u16 DecorGfx_BLUE_BED[] = { OBJ_EVENT_GFX_HYDRA_BED_BLUE }; //HYDRA
const u16 DecorGfx_YELLOW_BED[] = { OBJ_EVENT_GFX_HYDRA_BED_YELLOW }; //HYDRA
const u16 DecorGfx_GREEN_BED[] = { OBJ_EVENT_GFX_HYDRA_BED_GREEN }; //HYDRA
const u16 DecorGfx_ORANGE_BED[] = { OBJ_EVENT_GFX_HYDRA_BED_ORANGE }; //HYDRA
const u16 DecorGfx_PURPLE_BED[] = { OBJ_EVENT_GFX_HYDRA_BED_PURPLE }; //HYDRA
const u16 DecorGfx_WHITE_BED[] = { OBJ_EVENT_GFX_HYDRA_BED_WHITE }; //HYDRA
const u16 DecorGfx_BLACK_BED[] = { OBJ_EVENT_GFX_HYDRA_BED_BLACK }; //HYDRA
const u16 DecorGfx_PINK_BED[] = { OBJ_EVENT_GFX_HYDRA_BED_PINK }; //HYDRA
