const struct Decoration gDecorations[] =
{
    ...
    //HYDRA HYPER PC - EV/IV/Nature/Ability editor machine (floor furniture, 1x2)
    [DECOR_HYPER_TRAINING_PC] =
    {
        .id = DECOR_HYPER_TRAINING_PC,
        .name = _("HYPER PC"),
        .permission = DECORPERM_BEHIND_FLOOR, //HYDRA tree-like: top passable, placeable over wall
        .shape = DECORSHAPE_1x2,
        .category = DECORCAT_MISC, //HYDRA grouped with the incubator
        .price = 10000, //HYDRA matches the priciest vanilla decorations (the large dolls)
        .description = COMPOUND_STRING(
            "A machine that\n"
            "tunes a POKEMON's\n"
            "hidden potential."),
        .tiles = DecorGfx_HYPER_TRAINING_PC,
        .icon = {NULL, NULL},
    },

    //HYDRA EGG INCUBATOR - animated sprite decoration; holds an egg that hatches as you walk.
    // Sprite decoration (like the large 1x2 dolls) so it can animate through its 4 state frames.
    [DECOR_EGG_INCUBATOR] =
    {
        ...
        .permission = DECORPERM_SPRITE,
        .shape = DECORSHAPE_1x2,
        .category = DECORCAT_MISC, //HYDRA grouped with the HYPER PC
        .price = 10000,
        .description = COMPOUND_STRING(
            "Warms a POKEMON\n"
            "EGG, hatching it\n"
    ...
    //HYDRA RADIO - sprite decoration; plays a track you pick, in your own base (limit 1)
    [DECOR_RADIO] =
    {
        .id = DECOR_RADIO,
        .name = _("RADIO"),
        .permission = DECORPERM_SPRITE,
        .shape = DECORSHAPE_1x2, //HYDRA 16x32; top half draws over the player when behind
        .category = DECORCAT_MISC, //HYDRA grouped with the incubator + HYPER PC
        .price = 5000,
        .description = COMPOUND_STRING(
            "Plays a song of\n"
            "your choice in\n"
            "your SECRET BASE."),
        .tiles = DecorGfx_RADIO,
        .icon = {NULL, NULL},
    },

    //HYDRA HEALING BEDS - 9 colours; sprite decoration (2x2). Interacting rests + full-heals the party.
    [DECOR_RED_BED] =
    {
        .id = DECOR_RED_BED, .name = _("RED BED"),
        .permission = DECORPERM_SPRITE, .shape = DECORSHAPE_2x2, .category = DECORCAT_FURNITURE, .price = 8000,
        .description = COMPOUND_STRING("A cozy bed. Rest\nhere to heal your\nPOKEMON."),
        .tiles = DecorGfx_RED_BED, .icon = {NULL, NULL},
    },
    [DECOR_BLUE_BED] =
    {
        .id = DECOR_BLUE_BED, .name = _("BLUE BED"),
        .permission = DECORPERM_SPRITE, .shape = DECORSHAPE_2x2, .category = DECORCAT_FURNITURE, .price = 8000,
        .description = COMPOUND_STRING("A cozy bed. Rest\nhere to heal your\nPOKEMON."),
        .tiles = DecorGfx_BLUE_BED, .icon = {NULL, NULL},
    },
    [DECOR_YELLOW_BED] =
    {
        .id = DECOR_YELLOW_BED, .name = _("YELLOW BED"),
        .permission = DECORPERM_SPRITE, .shape = DECORSHAPE_2x2, .category = DECORCAT_FURNITURE, .price = 8000,
        .description = COMPOUND_STRING("A cozy bed. Rest\nhere to heal your\nPOKEMON."),
        .tiles = DecorGfx_YELLOW_BED, .icon = {NULL, NULL},
    },
    [DECOR_GREEN_BED] =
    {
        .id = DECOR_GREEN_BED, .name = _("GREEN BED"),
        .permission = DECORPERM_SPRITE, .shape = DECORSHAPE_2x2, .category = DECORCAT_FURNITURE, .price = 8000,
        .description = COMPOUND_STRING("A cozy bed. Rest\nhere to heal your\nPOKEMON."),
        .tiles = DecorGfx_GREEN_BED, .icon = {NULL, NULL},
    },
    [DECOR_ORANGE_BED] =
    {
        .id = DECOR_ORANGE_BED, .name = _("ORANGE BED"),
        .permission = DECORPERM_SPRITE, .shape = DECORSHAPE_2x2, .category = DECORCAT_FURNITURE, .price = 8000,
        .description = COMPOUND_STRING("A cozy bed. Rest\nhere to heal your\nPOKEMON."),
        .tiles = DecorGfx_ORANGE_BED, .icon = {NULL, NULL},
    },
    [DECOR_PURPLE_BED] =
    {
        .id = DECOR_PURPLE_BED, .name = _("PURPLE BED"),
        .permission = DECORPERM_SPRITE, .shape = DECORSHAPE_2x2, .category = DECORCAT_FURNITURE, .price = 8000,
        .description = COMPOUND_STRING("A cozy bed. Rest\nhere to heal your\nPOKEMON."),
        .tiles = DecorGfx_PURPLE_BED, .icon = {NULL, NULL},
    },
    [DECOR_WHITE_BED] =
    {
        .id = DECOR_WHITE_BED, .name = _("WHITE BED"),
        .permission = DECORPERM_SPRITE, .shape = DECORSHAPE_2x2, .category = DECORCAT_FURNITURE, .price = 8000,
        .description = COMPOUND_STRING("A cozy bed. Rest\nhere to heal your\nPOKEMON."),
        .tiles = DecorGfx_WHITE_BED, .icon = {NULL, NULL},
    },
    [DECOR_BLACK_BED] =
    {
        .id = DECOR_BLACK_BED, .name = _("BLACK BED"),
        .permission = DECORPERM_SPRITE, .shape = DECORSHAPE_2x2, .category = DECORCAT_FURNITURE, .price = 8000,
        .description = COMPOUND_STRING("A cozy bed. Rest\nhere to heal your\nPOKEMON."),
        .tiles = DecorGfx_BLACK_BED, .icon = {NULL, NULL},
    },
    [DECOR_PINK_BED] =
    {
        .id = DECOR_PINK_BED, .name = _("PINK BED"),
        .permission = DECORPERM_SPRITE, .shape = DECORSHAPE_2x2, .category = DECORCAT_FURNITURE, .price = 8000,
        .description = COMPOUND_STRING("A cozy bed. Rest\nhere to heal your\nPOKEMON."),
        .tiles = DecorGfx_PINK_BED, .icon = {NULL, NULL},
    }
};
