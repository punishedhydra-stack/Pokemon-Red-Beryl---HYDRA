...
const struct FrontierBrain gFrontierBrainInfo[NUM_FRONTIER_FACILITIES] =
{
    [FRONTIER_FACILITY_TOWER] =
    {
        ...
        .battledBit = {1 << 0, 1 << 1},
        .streakAppearances = {35, 70, 35, 1}, //#HYDRA silver_streak, gold_streak, repeat_interval, offset
    },
...
u8 GetFrontierBrainStatus(void)
{
    ...
    if (battleMode != FRONTIER_MODE_SINGLES && battleMode != FRONTIER_MODE_DOUBLES) //#HYDRA
